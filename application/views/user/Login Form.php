...
<body>    
  ...
  <?php if ($this->session->flashdata('alert')) : ?>
    <div class="col-md-12" style="float:none; margin:0 auto;">
      <div class="alert alert-success alert-dismissible fade show" role="alert">
        Login Gagal, <?= $this->session->flashdata('alert'); ?>.
  ...
  <?php endif;?>       
    ...
    <form action="<?= base_url('C_Dangdan_User/Signin')?>" id="form_login" name="form_login" method="post" class="form-horizontal">
      <form class="login-form validate-form">
				...
				<div class="wrap-input validate-input" style="margin-bottom: 23">
					<span class="label-input">Email</span>
						<input class="input" type="email" name="email_customer" id="email_customer"require="">
				</div>
            ...
            <button type="submit" class="login-form-btn">Login</button>
				...
				<div style="padding-top: 25px; padding-left: 165">
					<a href="<?= site_url('C_Dangdan_User/registrasi')?>" class="txt2">
						<center>Sign Up</center>
					</a>
				</div>

        <div style="margin-left:;padding-top: 55px; padding-left: 165">
					<a href="<?= site_url('C_Dangdan_Montir/loginMontir')?>" class="txt2">
            <center>Login Montir</center>
					</a>
				</div>

        <div style="margin-left:;padding-top: 25px; padding-left: 165">
					<a href="<?= site_url('C_Dangdan_Admin/loginAdmin')?>" class="txt2">
