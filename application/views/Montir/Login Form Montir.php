...
<body>                  
  ...
  <?php endif;?>
    <form action="<?= base_url('C_Dangdan_Montir/SigninMontir')?>" id="form_login" name="form_login" method="post" class="form-horizontal">
      <form class="login-form validate-form">
				...
				<div class="wrap-input validate-input" style="margin-bottom: 23">
					<span class="label-input">Email</span>
						<input class="input" type="email" name="email_montir" id="email_montir"require="">
				</div>
